...
export const initialAssets: Asset[] = [
  ...
  { id: 'AST-004', name: 'ECG Machine 12-Lead',             serial: 'ECG-3301',    qty: 3,  weight: '8kg',    supplier: 'GE Healthcare Ethiopia', status: 'Functional',           location: 'Cardiology Dept', addedAt: '2025-06-05', rfidTag: 'RF-A004-ECG',  barcode: '8934567890004', photoUrl: '/ecg_thumb.png' },
  { id: 'AST-005', name: 'Infusion Pump Set',               serial: 'INF-7890',    qty: 20, weight: '1.2kg',  supplier: 'B. Braun Ethiopia',       status: 'Maintenance Required', location: 'ICU',             addedAt: '2025-08-10', rfidTag: 'RF-A005-INF',  barcode: '8934567890005', photoUrl: '/infusion_thumb.png' },
  { id: 'AST-045', name: 'Laparoscopic Tower',              serial: 'LAP-2045-X',  qty: 1,  weight: '85kg',   supplier: 'Karl Storz',              status: 'In Use (OT 1)',        location: 'OT Suite',        addedAt: '2024-08-15', rfidTag: 'RF-A045-LAP',  barcode: '8934567890045', photoUrl: '/laparoscopic_thumb.png' },
  { id: 'AST-088', name: 'C-Arm X-Ray',                    serial: 'CARM-088',    qty: 1,  weight: '120kg',  supplier: 'Siemens Healthineers',    status: 'Functional',           location: 'OT Suite',        addedAt: '2024-10-01', rfidTag: 'RF-A088-CAR',  barcode: '8934567890088', photoUrl: '/carm_thumb.png' },
];
