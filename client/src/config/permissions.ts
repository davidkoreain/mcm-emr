...
export const MENU_STRUCTURE: MenuItem[] = [
  ...
  { key: 'operation', label: 'Operations', icon: 'Scissors', children: [
    ...
    { key: 'operation.resources', label: 'Team & Resources' },
    { key: 'operation.checklists',label: 'Checklists' },
    { key: 'operation.outcomes',  label: 'Outcomes' },
    { key: 'operation.bedtrace',  label: 'Bed Trace' },
  ]},
...
export const DEFAULT_PERMISSIONS: AllPerms = {
  Admin: {
    ...
    operation: true, 'operation.schedule': true, 'operation.resources': true, 'operation.checklists': true, 'operation.outcomes': true, 'operation.bedtrace': true,
  ...
  Manager: {
    ...
    operation: false, 'operation.schedule': false, 'operation.resources': false, 'operation.checklists': false, 'operation.outcomes': false, 'operation.bedtrace': false,
  ...
  Nurse: {
    ...
    operation: true, 'operation.schedule': true, 'operation.resources': true, 'operation.checklists': true, 'operation.outcomes': false, 'operation.bedtrace': true,
    pharmacy: true, 'pharmacy.prescriptions': true, 'pharmacy.inventory': false, 'pharmacy.history': false,
    assets: false, 'assets.inventory': false, 'assets.maintenance': false, 'assets.loss': false,
    settings: false, 'settings.permissions': false, 'settings.menu_config': false, 'settings.adjustment': false,
  },
